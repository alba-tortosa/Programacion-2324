...
public class UIAmigoInvisible {
    ...
    private void consultar() {
        ...
        if (juego.totalParticipantes() == 0) {
            ...
            try {
                ...
                System.out.println(nombre + " envia a " + nombreRegalaA);
                System.out.println(nombre + " recibe de " + nombreRecibeDe);
    ...
    private void crearParticipantes() {
        ...
        juego.borrarTodos();
        System.out.println("Teclee numero de participantes en el amigo invisible");
    ...
    public static void main(String[] args) {
        UIAmigoInvisible interfaz = new UIAmigoInvisible(new JuegoAmigoInvisible());
        interfaz.ejecutar();
    }
}
