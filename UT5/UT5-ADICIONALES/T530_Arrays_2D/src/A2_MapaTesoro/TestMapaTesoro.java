...
public class TestMapaTesoro {
    public static void main(String[] args) {
        ...
        System.out.println("Mapa del tesoro:(" + mapa.getFilas() + " filas , " + mapa.getColumnas() + " columnas)\n");
        ...
        for (int i = 0; i < posFilas.length; i++) {
            System.out.println("(" + posFilas[i] + ", " + posColumnas[i] + "): " + mapa.hayTesoro(posFilas[i],
                    posColumnas[i]));
        ...
        for (int i = 0; i < posFilas.length; i++) {
            System.out.println("(" + posFilas[i] + "," + " " + posColumnas[i] + "): " + mapa.calcularNumeroTesorosAdyacentes(posFilas[i], posColumnas[i]));
        ...
        System.out.println("Si hay tesoro en esa posicion => 9");
        System.out.println("Si no hay tesoro en esa posicion =>" + "numero de tesoros adyacentes a la misma\n");
