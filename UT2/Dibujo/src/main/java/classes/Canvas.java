...
/**
 * classes.Canvas es una clase para realizar dibujos gráficos de una forma simple sobre el
 * classes.Canvas, el lienzo
 * @author: Bruce Quig
...
public class Canvas
{
    ...
    // es un poco m�s complejo de lo necesario. Se ha hecho as� con el prop�sito de mantener
    // la interfaz y los atributos de instancia de los objetos figura claros y simples para
    // prop�sitos educacionales
     ...
     * cuando se hace visible. Este método puede ser utilizado tambi�n para traer delante
     ...
     */
     ...
     // Se ha hecho as� para mantener los interfaces de figura claros y simples
     // para prop�sitos educacionales
     
     public void dibujar(Object referenciaObjeto, String color, Shape figura)    {
        objetos.remove(referenciaObjeto);   // solo en caso de que ya est�
        objetos.add(referenciaObjeto);      // a�adir al final
    ...
    /**
     * Establecer el color de fondo del classes.Canvas
    ...
    /**
     *Esperar un n�emro determinado de milisegundos antes de acabar.
     *Esto proporciona una manera de especificar un peque�o retraso 
    ...
    public void esperar(int milisegundos)    {
        try     {
            ...
            // ignorar la excepci�n en este momento
        }
    }

    /**
     * Redibujar todas las figuras que est�n actualmente en el canvas
     */
     ...
     * contenido en el marco classes.Canvas. Es esencialmente un JPanel con capacidad
     * a�adida para refrescar la imagen dibujada en el
     */
