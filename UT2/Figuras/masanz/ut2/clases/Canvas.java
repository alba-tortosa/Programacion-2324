...
/**
 * masanz.ut2.clases.Canvas es una clase para realizar dibujos gráficos de una forma simple sobre el
 * masanz.ut2.clases.Canvas, el lienzo
 * @author: Bruce Quig
...
public class Canvas
{
    ...
    public static Canvas getCanvas()    {
        if (canvasSingleton == null) {
            canvasSingleton = new Canvas("Figuras Demo", 300, 300,
                Color.white);
        }
    ...
    /**
     * Crea el masanz.ut2.clases.Canvas
    ...
    /**
     * Establecer el color de fondo del masanz.ut2.clases.Canvas
     * @param  colorString el nuevo color para el fondo del canvas
     */
     ...
     * contenido en el marco masanz.ut2.clases.Canvas. Es esencialmente un JPanel con capacidad
