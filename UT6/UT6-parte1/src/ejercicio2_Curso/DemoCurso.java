...
public class DemoCurso {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hay " + dam.cuantosAlumnos() + " alumnos");
        System.out.println(dam.toString());

        System.out.printf("La media es %4.2f", dam.getMedia());
        System.out.println("\nAlumno con nota maxima " + dam.alumnoNotaMaxima());

        int suspensoMasAlto = dam.suspensoMasAlto();
        if (suspensoMasAlto == 0) {
            System.out.println("No hay suspensos");
        } else {
            System.out.println("Suspenso mas alto " + suspensoMasAlto);
        }

        System.out.println("Dos notas mas altas " + dam.dosNotasMasAltas());
