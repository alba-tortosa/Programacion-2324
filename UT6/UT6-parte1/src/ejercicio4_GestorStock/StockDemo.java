...
public class StockDemo {
    ...
    public void recibirProducto() {
        ...
        gestor.escribirDetallesProductosV1();
        // Llegada de  artçiculos de varios productos
    ...
    /**
     * Vender un articulo de un producto
     * Mostra el estado del producto antes y despues de la venta
     *
    ...
    /**
     * Mostrar productos del almacen con nivel
    ...
    public static void main(String[] args) {
        ...
        if (producto == null) {
            System.out.println("Producto con ID: " + id + " no se reconoce.");
        } else {
